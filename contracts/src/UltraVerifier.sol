// Verification Key Hash: cc5cfd7648bd9240d6edd979f3a276494a2d9ac3617815af4b2347292d4dd6c3
...
library UltraVerificationKey {
    function verificationKeyHash() internal pure returns(bytes32) {
        return 0xcc5cfd7648bd9240d6edd979f3a276494a2d9ac3617815af4b2347292d4dd6c3;
    }
    ...
    function loadVerificationKey(uint256 _vk, uint256 _omegaInverseLoc) internal pure {
        assembly {
            ...
            mstore(add(_vk, 0x80), 0x149e001a47d8d406b4e911bd2e9637c78de1d5ade7d972b6c75c67b18e1e6a06) // vk.Q1.x
            mstore(add(_vk, 0xa0), 0x0c406ec76627569a8f1831249a37719a03ad01e6d88b5c3a40c197d6fd24bf37) // vk.Q1.y
            ...
            mstore(add(_vk, 0x100), 0x00d38478e5d91fe7164f80ac60e250944bfae306e26197eddacc3ca5651010c3) // vk.Q3.x
            mstore(add(_vk, 0x120), 0x1a38dfc5e9c11ef32395f751a66c10e254acde982d9775c08cc5cb1e7641fdf7) // vk.Q3.y
            ...
            mstore(add(_vk, 0x180), 0x0df74ff4ab0f4660f48e95fb839a367b9b716ec5be4b80a0625c2390708010d5) // vk.Q_M.x
            mstore(add(_vk, 0x1a0), 0x2dd6f02ad0111b5ffbcfd893a741a39c2804764235202cddb54021cb6df85007) // vk.Q_M.y
            ...
            mstore(add(_vk, 0x200), 0x2d3fe022cf15c195cc206b0197aa16748884c3ce5f5c7a4db7f3b8c405ec30eb) // vk.Q_ARITHMETIC.x
            mstore(add(_vk, 0x220), 0x0a2328fabf295546e3cd503af4c5fac47f0ef162914c777b834932fe552712ad) // vk.Q_ARITHMETIC.y
            ...
            mstore(add(_vk, 0x300), 0x2d3cc048486e0b8ea0f69cd66256da16c7d24fff0d19fd1733f794640d8720e6) // vk.SIGMA1.x
            mstore(add(_vk, 0x320), 0x13a588ba0b993dc69db3b12ebbd4343d0ab655215bcf5f8ca4ea281337d2000d) // vk.SIGMA1.y
            mstore(add(_vk, 0x340), 0x0845a745f5b58ff4dbc44192e10d69c1e180dd95a892b30969ffb2a7c0521637) // vk.SIGMA2.x
            mstore(add(_vk, 0x360), 0x1d13bb36e90d08a9998012636080f40644f14a717f66785682e370d77938d7da) // vk.SIGMA2.y
            mstore(add(_vk, 0x380), 0x0693caa4151e1b5de0426fc43a85ac2070c2a0b698d0b3ab72a3d05eeb4b8054) // vk.SIGMA3.x
            mstore(add(_vk, 0x3a0), 0x071480d0a5dfc69a6b50e04a0c7e98156918d6bb2c0e25311587bb8cb5f088bb) // vk.SIGMA3.y
            mstore(add(_vk, 0x3c0), 0x0a3df75e822f95904a8e624d6d9e9518284aa2785e6ed542f46db29e291ab47c) // vk.SIGMA4.x
            mstore(add(_vk, 0x3e0), 0x0f0c09ee11c024d6d6e03b3b5930f9da66af04f4fcb92c807c84f5a6dc1dbbea) // vk.SIGMA4.y
            ...
            mstore(add(_vk, 0x540), 0x0c26fa4650304912fef78aa5ae227c8c4dbe0d04bde457184dc427dd1089f30b) // vk.ID1.x
            mstore(add(_vk, 0x560), 0x14bb35aa5f297868bbfc58866a28bd9fc7559077168434ff1ec9ba75a40d5af1) // vk.ID1.y
            mstore(add(_vk, 0x580), 0x16a89139fe3a333c72c4a14224c07d63c750cf41622cc9e5c28dfd313b59a79b) // vk.ID2.x
            mstore(add(_vk, 0x5a0), 0x18fb5b6730e8dff052db83418f01cab036b8f3cfb53ffa8058aa5f29c8f32013) // vk.ID2.y
            mstore(add(_vk, 0x5c0), 0x224da1e610273d1dc1d1d3ca6b0db527c4057cfe2076276627dfe95d0cfc128f) // vk.ID3.x
            mstore(add(_vk, 0x5e0), 0x0c5d022379e7e299bb8c805d7c894ab6a951f612df153d083ddde40a5b45a3bb) // vk.ID3.y
